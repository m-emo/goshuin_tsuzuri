...
class _RootWidgetState extends State<RootWidget> {
  ...
  void initState() {
    ...
    // DBからデータ取得
    // 御朱印最大ID取得
    // GoshuinData goshuin = DbGoshuinData().getMaxIdGoshuin();
